<?php
  ...
  class Mail {
    ...
    function __construct() {
      ...
      $this->mail->SMTPSecure = $config['mail-SMTPSecure'];                            // Enable TLS encryption, `ssl` also accepted
      $this->mail->Port = $config['mail-port'];                                    // TCP port to connect to

      $this->mail->setFrom($config['mail-sendFormAdress'], $config['mail-senderName']);
